...
$getCompt = $conn->query("SELECT * FROM `departments`,`doctors`,`complaints` WHERE departments.dept_id=complaints.dept and doctors.doc_id=complaints.c_id and complaints.c_id=$c_id");
