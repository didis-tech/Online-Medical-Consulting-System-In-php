...
$getDepts=$conn->query("SELECT * FROM `departments`,`complaints` WHERE departments.dept_id=complaints.dept AND complaints.user_id=$id");
$count=0;
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0 datatable">
                                ...
                                <?php foreach($getDepts as $key => $dept): ?>
                                   ...
                                   $count=$count+1;
                                     if($dept['c_status'] == 'completed'){
                                         $status = 'status-green';
                                     }elseif($dept['c_status'] == 'in progress'){
                                    ...
                                    <tr>
										...
										<td><span class="custom-badge <?php echo $status; ?>"><?php echo $dept['c_status']; ?></span></td>
                                        <td class="text-right">
                                            <a href="view-diagnosis.php?c_id=<?php echo $dept['c_id'] ?>" class="btn btn-sm btn-primary <?php if($dept['c_status'] !== "completed") echo 'disabled'; ?>"> <i class="fa fa-eye">View</i> </a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
