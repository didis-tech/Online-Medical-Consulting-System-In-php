...
if(isset($_GET['dept'])){
    $dept_id=$_GET['dept'];
    $getDepts=$conn->query("SELECT * FROM departments where dept_id = '$dept_id'");
    $dept = $getDepts->fetch_assoc();
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form id="update">
                        <input class="form-control" type="hidden" name="old_name" value="<?php echo $dept_name; ?>" required>
                        <input class="form-control" type="hidden" name="dept_id" value="<?php echo $dept_id; ?>" required>
							<div class="form-group">
								<label>Department Name</label>
								<input class="form-control" type="text" name="name" value="<?php echo $dept_name; ?>" required>
							</div>
