                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#!" data-toggle="modal" data-target="#myModal" id="upload-demo-i"><img class="avatar" src="<?php echo $dp ?>" alt=""></a>
                                    </div>
                                </div>
                                <!-- The Modal -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="staff-id">User ID : PAT-0<?php echo $id ?></div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="tel:<?php echo $phone ?>"><?php echo $phone ?></a></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $age->format('%y years'); ?></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $lga ?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="experience-content">
                                                        <div class="timeline-content">
                                                            <a href="#!" class="name"><?php echo $address ?></a>
                                                            <div><?php echo $lga ?></div>
