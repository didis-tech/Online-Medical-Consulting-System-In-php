                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="profile-img-wrap" id="upload-demo-i"  data-toggle="modal" data-target="#myModal">
                                    <img class="inline-block" src="<?php echo $dp ?>" alt="user">
                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                          <div class="form-group form-focus">
                                              ...
                                              <input type="text" name="firstname" value="<?php echo $firstname ?>" class="form-control floating"  required/>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group form-focus">
                                              <label class="focus-label">Last Name</label>
                                              <input type="text" name="lastname" value="<?php echo $lastname ?>" class="form-control floating"  required/>
                                          </div>
                                      </div>
                                        <div class="col-md-12">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">Date of Birth</label>
                                                <input type="text" value="<?php echo $DoB ?>" class="form-control floating" value="John" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="text" name="address" class="form-control floating" value="<?php echo $address ?>" required/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">States</label>
                                    <select class="select form-control floating" onchange="toggleLGA(this);"
                                    name="state"
                                    id="state" required >
                                    <?php foreach ($states as $key => $dstate): ?>
                                    <option value="<?php echo $dstate ?>" <?php if($dstate == $state) echo "selected" ?>><?php echo $dstate ?></option>
                                    <?php endforeach; ?>
                                </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <select
                                      name="lga"
                                      id="lga"
                                      class="form-control select-lga floating"
                                      required
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <input name="tel" type="text" class="form-control floating" value="<?php echo $phone ?>"  required/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Email Address</label>
                                    <input name="email" type="email" class="form-control floating" value="<?php echo $email ?> " required/>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <script type="text/javascript">
                              ...
                              var vidFileLength = $("#upload")[0].files.length;
                                          ...
                                          $uploadCrop.croppie('result', {
                                            ...
                                            $.ajax({
                                              url: "../resources/user_upload_dp.php",
                                              type: "POST",
                                              data: {"image":resp},
                                              success: function (data) {
                                              $('#myModal').modal('hide');
