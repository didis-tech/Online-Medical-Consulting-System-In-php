...
$getActs = $conn->query("SELECT * FROM `activities`,`users`,`doctors` WHERE activities.p_id=users.p_id AND activities.d_id=doctors.doc_id AND activities.d_id=$id  order by activities.act_id desc");
$conn->query("UPDATE `activities` SET d_stat='seen' WHERE d_id=$id");
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <?php foreach ($getActs as $key => $activity) : ?>
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="#!" title="<?php echo $activity['p_firstname'] . ' ' . $activity['p_lastname'] ?>" data-toggle="tooltip" class="avatar">
                                                    <img alt="<?php echo $activity['p_firstname'] . ' ' . $activity['p_lastname'] ?>" src="../users/assets/img/<?php echo $activity['p_dp'] ?>" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <?php echo $activity['d_noti'] ?>
