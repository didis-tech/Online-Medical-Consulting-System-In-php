...
$getDoctors = $conn->query("SELECT * FROM doctors");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row doctor-grid">
                    <?php foreach ($getDoctors as $key => $doc) : ?>
                        <?php $getDocDept = $conn->query("SELECT * FROM `departments` where dept_id ='" . $doc['doc_dept'] . "'");
                        $dept_row = $getDocDept->fetch_assoc();
                        $d_dept = $dept_row['dept_name']; ?>
                        <div class="col-md-4 col-sm-4  col-lg-3">
                            <div class="profile-widget">
                                <div class="doctor-img">
                                    <a class="avatar" href=""><img alt="" src="assets/img/<?php echo $doc['doc_dp']; ?>"></a>
                                </div>
                                ...
                                <h4 class="doctor-name text-ellipsis"><a href="profile.php"><?php echo $doc['doc_name']; ?></a></h4>
                                <div class="doc-prof"><?php echo $d_dept; ?></div>
                                <div class="user-country">
                                    <i class="fa fa-map-marker"></i> <?php echo $doc['doc_address']; ?>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
